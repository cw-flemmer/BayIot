...
const WidgetCard = ({ widget, onDelete, isDraggable, showDelete }) => {
    ...
    return (
        <div className={`h-full w-full bg-[#1e293b]/80 backdrop-blur-md border border-orange-400 rounded-3xl p-5 flex flex-col items-center relative group overflow-hidden shadow-xl transition-all duration-300 hover:shadow-[0_0_30px_rgba(251,146,60,0.3)] hover:border-orange-300 ${isDraggable ? 'cursor-move drag-handle' : ''}`}>
            {/* Header */}

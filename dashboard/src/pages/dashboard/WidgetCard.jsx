...
const WidgetCard = ({ widget, onDelete, isDraggable, showDelete }) => {
    ...
    return (
        <div className={`h-full w-full bg-[#1e293b]/80 backdrop-blur-md border border-orange-500 rounded-3xl p-5 flex flex-col items-center relative group overflow-hidden shadow-xl ${isDraggable ? 'cursor-move drag-handle' : ''}`}>
            {/* Header */}
